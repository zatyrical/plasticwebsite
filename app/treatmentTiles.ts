...
export const reconstructiveTreatments: TreatmentTile[] = [
...
export const reconstructiveSignatureTreatments: TreatmentTile[] = [
  { title: 'Lymphedema surgery & supermicrosurgical LVA', href: '/lymphedema-surgery-singapore', image: '/images/reconstructive-tiles/lymphedema-surgery.jpg', alt: 'Swollen arm image representing lymphedema surgery' },
  { title: 'Breast reconstruction', href: '/breast-reconstruction-singapore', image: '/images/reconstructive-tiles/breast-reconstruction.jpg', alt: 'Silicone breast implant image representing breast reconstruction surgery' },
  { title: 'Scar & laceration reconstruction', href: '/scar-reconstruction-singapore', image: '/images/reconstructive-tiles/scar-reconstruction.jpg', alt: 'Keloid scar image representing scar reconstruction' }
];
