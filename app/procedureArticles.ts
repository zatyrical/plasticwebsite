...
export const procedureArticles: Record<string, ProcedureArticle> = {
  ...
  'tummy-tuck-singapore': {
    ...
    faqs: [
      ...
      { question: 'How should I choose a tummy tuck doctor in Singapore?', answer: 'Useful points to discuss include specialist training in plastic surgery, experience with abdominal contouring, assessment of loose skin versus fat versus diastasis recti, scar planning, anaesthesia safety, recovery support and how complications are handled. A consultation is needed to decide whether tummy tuck, liposuction, staged treatment or no surgery is appropriate.' },
  ...
  'child-facial-laceration-plastic-surgeon-singapore': {
    slug: 'child-facial-laceration-plastic-surgeon-singapore',
    title: 'Child Facial Laceration Repair in Singapore',
    eyebrow: 'Child facial lacerations',
    lead: 'A parent-focused guide to facial cuts in children, including when plastic surgical assessment may be helpful, deeper structure checks, layered closure, wound-edge eversion, scar care and anaesthesia options.',
    ...
    sections: [
      { id: 'when-to-seek-help', heading: 'When should a child’s facial cut be assessed urgently?', paragraphs: ['Parents should seek prompt medical assessment when the wound is deep, gaping, contaminated, bleeding heavily, caused by a bite, or located near an important facial structure. Timing matters because cleaning, exploration and closure decisions may change as swelling, contamination or infection risk evolves.'], items: ['cuts crossing the lip border, eyelid, eyebrow, nose or ear', 'visible fat, muscle, cartilage, bone or foreign material', 'numbness, facial weakness, drooling or difficulty moving part of the face', 'possible salivary duct injury around the cheek or parotid area', 'animal or human bites, dirty wounds or road-rash injuries', 'heavy bleeding, rapidly increasing swelling or a child who cannot cooperate safely'] },
      { id: 'plastic-surgeon-assessment', heading: 'What does a plastic surgeon assess?', paragraphs: ['Assessment looks at the mechanism of injury, wound depth, tissue loss, contamination, tetanus status and whether important structures may be involved. This helps decide whether the wound can be closed simply or needs more careful exploration and layered repair.', 'Facial lacerations are not always just skin injuries. Depending on the location, the surgeon may check eyelid structures, the lip vermilion border, nose cartilage, facial muscles, sensory nerves, motor nerves, salivary ducts and the direction of relaxed skin tension lines.'], items: ['depth of the cut and whether muscle is divided', 'alignment of facial landmarks such as the lip border or eyelid margin', 'sensation and movement around the wound', 'possible nerve, duct, cartilage or deeper soft-tissue injury', 'contamination, bite risk and whether antibiotics or debridement are needed'] },
      { id: 'muscle-and-function', heading: 'Why muscle repair may matter', paragraphs: ['The muscles of facial expression are small, layered and direction-specific. If a cut passes through muscle, closing only the skin may leave deeper separation, contour irregularity or impaired function.', 'Where appropriate, repairing the muscle layer can help restore the deeper anatomy, reduce dead space and reduce tension on the skin closure. This is especially relevant around the lips, cheek, chin and forehead, where movement and expression can place repeated stress on a healing wound.'] },
      { id: 'layered-closure', heading: 'Layered closure and wound-edge eversion', paragraphs: ['Layered closure means closing the deeper tissues with absorbable sutures before closing the skin. This can reduce tension on the skin edges and support the wound while it heals.', 'For many facial wounds, the skin edges are gently turned outward, or everted, during repair. This may look slightly raised immediately after stitching, but properly everted edges often settle flatter as the wound contracts and matures. If the edges are turned inward, the final scar may become depressed or more noticeable.', 'Good repair also depends on careful tissue handling, accurate alignment, appropriate suture choice and follow-up. Even with meticulous repair, scars vary with injury severity, skin type, tension, infection risk and aftercare.'] },
      { id: 'anaesthesia-options', heading: 'Local anaesthesia, conscious sedation or general anaesthesia?', paragraphs: ['The safest anaesthetic option depends on the child’s age, cooperation, anxiety level, fasting status, medical history, wound location and wound complexity. The aim is not simply to “get the stitches done”, but to clean, assess and repair the wound accurately while keeping the child comfortable and still.', 'Older cooperative children with small, straightforward wounds may be repaired under local anaesthesia. This usually involves numbing the area with an injection, sometimes after topical numbing medicine if appropriate. The injection can be briefly uncomfortable, but the repair itself should not feel sharp pain.', 'Some children are old enough to avoid general anaesthesia but too anxious or distressed for local anaesthesia alone. Conscious sedation may be considered in a monitored setting with trained staff, especially when a wound is sensitive or needs a more precise repair.', 'Younger children, very distressed children or children with deep or complex facial wounds may need general anaesthesia. Being fully asleep can sometimes be the safest way to allow careful cleaning, exploration, muscle repair and accurate alignment of the lip, eyelid, nose or other facial landmarks.'], items: ['local anaesthesia: often suitable for older cooperative children and shorter, simpler repairs', 'conscious sedation: may help anxious children or moderately complex wounds when appropriate monitoring is available', 'general anaesthesia: may be safer for toddlers, very distressed children, deep wounds, multiple-layer repair or injuries involving important structures'] },
      { id: 'common-sites', heading: 'Common facial laceration sites in children', paragraphs: ['Forehead, eyebrow and chin cuts are common after falls. Lip lacerations need careful alignment when they cross the vermilion border, because even a small step can be noticeable. Eyelid wounds may need assessment for margin, tear drainage or deeper structure involvement. Cheek wounds may need consideration of facial nerves or salivary ducts depending on depth and location.'] },
      { id: 'first-aid', heading: 'What parents can do immediately', paragraphs: ['Apply gentle pressure with clean gauze or cloth to control bleeding. If there is obvious dirt on the surface, gentle rinsing may help, but avoid repeatedly probing a deep wound or applying harsh antiseptics into the cut. Cover the wound and seek medical assessment if it is deep, gaping, dirty, caused by a bite or near the eye, lip, nose or ear.'], items: ['keep the child calm and seated if possible', 'apply steady pressure for bleeding', 'bring any information about allergies, medications and tetanus immunisation', 'avoid giving food or drink if sedation or general anaesthesia may be needed, unless advised by the treating team'] },
      { id: 'scar-care', heading: 'Scar care after stitches', paragraphs: ['Scar care begins after the wound has sealed and the treating team confirms it is safe. Follow-up may include wound checks, suture removal timing, silicone gel or sheets, sun protection and massage when appropriate. Parents should watch for increasing redness, swelling, discharge, fever, wound opening or worsening pain.', 'Scar maturation takes months. Early redness or firmness does not necessarily represent the final scar. Later scar treatments or revision can be discussed if a mature scar remains raised, widened, tethered, painful or poorly aligned.'] },
      { id: 'limits', heading: 'Risks and limitations', paragraphs: ['Risks include infection, bleeding, wound breakdown, visible scarring, hypertrophic or keloid scar, altered sensation, contour irregularity, retained foreign body, need for revision, anaesthetic risks and functional impairment depending on injury severity. No repair can guarantee an invisible scar.', 'This page provides general information for parents and does not replace urgent clinical assessment for a child with a facial wound. The appropriate repair method and anaesthetic plan should be individualised by the treating team.'] }
    ],
    faqs: [
      { question: 'Does my child need a plastic surgeon for stitches on the face?', answer: 'Not every facial cut needs a plastic surgeon. Specialist assessment may be helpful for deep, gaping or contaminated wounds, cuts crossing the lip or eyelid, injuries near important structures, or wounds where layered repair and precise alignment are important.' },
      { question: 'Will my child need to be put to sleep for facial stitches?', answer: 'Some older cooperative children can have repair under local anaesthesia. Anxious children may need monitored sedation. Very young or distressed children, or wounds needing careful layered repair, may be safer under general anaesthesia.' },
      { question: 'Why is layered closure important?', answer: 'Layered closure repairs deeper tissues first so that the skin is not carrying all the tension. This can support healing, reduce dead space and help the skin edges align more accurately.' },
      { question: 'Will a facial cut leave a scar?', answer: 'Any cut through the skin heals with a scar. Careful cleaning, accurate repair, wound-edge eversion, follow-up and scar care can help optimise the scar, but outcomes vary.' },
      { question: 'What should parents do before going to hospital?', answer: 'Apply gentle pressure, cover the wound with clean gauze, avoid repeated probing, bring allergy and tetanus information, and avoid food or drink if sedation or general anaesthesia may be required unless advised otherwise.' }
    ]
  },

  'facial-laceration-repair-singapore': {
    slug: 'facial-laceration-repair-singapore',
    title: 'Facial Laceration Repair Singapore | Face Cuts & Stitches',
    eyebrow: 'Facial laceration repair',
    lead: 'A practical guide to cuts on the face in Singapore, including when a facial laceration needs urgent assessment, layered closure, wound-edge eversion, scar care and when plastic surgical repair may be helpful.',
    ...
    sections: [
      { id: 'urgent-assessment', heading: 'When does a cut on the face need urgent assessment?', paragraphs: ['Seek prompt medical attention if the wound is deep, gaping, dirty, bleeding heavily, caused by a bite, or close to an important facial landmark. Timing matters because cleaning, exploration and closure decisions may change if swelling, contamination or infection develops.'], items: ['cuts crossing the lip border, eyelid margin, eyebrow, nose or ear', 'visible fat, muscle, cartilage, bone or foreign material', 'numbness, facial weakness, drooling or difficulty moving part of the face', 'possible salivary duct injury around the cheek', 'animal or human bites, road-rash injuries or dirty wounds', 'heavy bleeding, rapidly increasing swelling or a child who cannot cooperate safely'] },
      { id: 'plastic-surgeon-role', heading: 'What does a plastic surgeon look for in facial laceration repair?', paragraphs: ['The assessment looks beyond the visible skin gap. The surgeon considers how the injury happened, how deep the cut is, whether important structures may be injured, how much contamination is present, and whether the wound can be closed safely at that time.', 'Facial wounds may involve small muscles of expression, sensory nerves, motor nerves, salivary ducts, eyelid structures, nose cartilage or the lip vermilion border. Missing these issues can affect function, contour or final scar position.'], items: ['depth of the wound and whether muscle is divided', 'alignment of facial landmarks such as the lip border or eyelid', 'sensation and movement around the wound', 'contamination, bite risk and whether debridement or antibiotics are needed', 'whether local anaesthesia, sedation or general anaesthesia is safer'] },
      { id: 'layered-closure', heading: 'Layered closure and wound-edge eversion', paragraphs: ['Layered closure means deeper tissues are repaired first with absorbable sutures before the skin is closed. This can reduce tension on the skin edges, close dead space and support the wound during healing.', 'Wound-edge eversion means gently turning the skin edges slightly outward during closure. The wound may look a little raised immediately after repair, but properly everted edges often settle flatter as contraction and scar maturation occur. Edges that turn inward can leave a depressed or more visible scar.', 'Good repair also depends on cleaning, tissue handling, suture choice, tension control and follow-up. No technique can guarantee an invisible scar, and outcomes vary with wound severity, infection risk, skin type and aftercare.'] },
      { id: 'children', heading: 'Facial cuts in children', paragraphs: ['Children often injure the forehead, eyebrow, chin or lip after falls and playground accidents. A child’s age, anxiety level and ability to remain still affect how safely the wound can be assessed and repaired.', 'Older cooperative children may manage with local anaesthesia. Anxious children may need monitored sedation. Toddlers, very distressed children or complex wounds involving the lip, eyelid, nose or deeper layers may be safer under general anaesthesia so the wound can be cleaned and aligned accurately.'], items: ['bring allergy, medication and tetanus information', 'avoid giving food or drink if sedation or general anaesthesia may be needed, unless advised otherwise', 'specialist assessment may be helpful for deep, gaping, contaminated or landmark-crossing wounds'] },
      { id: 'first-aid', heading: 'What should I do immediately after a facial cut?', paragraphs: ['Apply steady pressure with clean gauze or cloth to control bleeding. If there is obvious surface dirt, gentle rinsing may help, but avoid repeatedly probing a deep wound or pouring harsh antiseptic into the cut. Cover the wound and seek medical assessment if it is deep, gaping, dirty, caused by a bite or near the eye, lip, nose or ear.'], items: ['keep the person calm and seated if possible', 'apply firm steady pressure rather than repeatedly checking the wound', 'do not pull out deeply embedded foreign material yourself', 'seek urgent help for eye symptoms, facial weakness, numbness or heavy bleeding'] },
      { id: 'scar-care', heading: 'Scar care after facial stitches', paragraphs: ['Scar care usually begins after the wound has sealed and the treating team confirms it is safe. Follow-up may include wound checks, timing of suture removal, silicone gel or sheets, sun protection and massage when appropriate.', 'Scars mature over months. Early redness, firmness or slight elevation is common and does not necessarily represent the final scar. Later treatment or scar revision can be discussed if a mature scar remains raised, widened, tethered, painful or poorly aligned.'] },
      { id: 'limits', heading: 'Risks and limitations', paragraphs: ['Risks include infection, bleeding, wound breakdown, visible scarring, hypertrophic or keloid scar, altered sensation, contour irregularity, retained foreign body, need for revision and anaesthetic risks. This page provides general information and does not replace urgent clinical assessment for a facial wound.'] }
    ],
    faqs: [
      { question: 'How do I fix a cut on my face?', answer: 'Apply steady pressure, cover the wound and seek medical assessment if the cut is deep, gaping, dirty, caused by a bite, bleeding heavily or near the eye, lip, nose or ear. Some cuts can be closed simply; deeper facial lacerations may need careful cleaning, layered closure and follow-up scar care.' },
      { question: 'Can a face cut be changed after it heals?', answer: 'Sometimes. A mature facial scar that is raised, widened, depressed, painful, tethered or poorly aligned may be assessed for scar treatment or revision. The best option depends on scar maturity, location, skin type and symptoms.' },
      { question: 'What is the fastest way to heal a cut on the face?', answer: 'Fast healing depends on proper cleaning, timely assessment, appropriate closure when needed, avoiding infection, not picking the wound, sun protection and following wound-care advice. There is no safe shortcut that guarantees an invisible scar.' },
      { question: 'What is surgery on your face called?', answer: 'The term depends on the problem. Repair of a cut may be called facial laceration repair or wound closure. Later improvement of a mature scar may be called scar revision.' },
      { question: 'When should a child’s facial cut be seen by a plastic surgeon?', answer: 'Specialist assessment may be helpful for deep, gaping or contaminated wounds, cuts crossing the lip or eyelid, injuries near important structures, or wounds where layered repair and precise alignment are important.' }
    ]
  },
