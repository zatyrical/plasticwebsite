      ...
      <section id="media" className="section media-home-section mobile-transition">
        <div className="container">
          ...
          <div className="grid-3 media-home-grid">
            ...
            <a className="card linked-card media-card media-visual-card" href="/media"><div className="media-card-image wide-media-image"><Image src="/images/media/cna-lymphedema-interview-screenshot.jpg" alt="CNA interview screenshot showing Dr Jeremy Sun discussing treatment for swelling of limbs" width={1280} height={500} /></div><small>CNA interview</small><h3>Treating swelling of limbs</h3><p>CNA interview segment on lymphedema screening and treatment, including CGH screening work for patients with limb swelling.</p><span>View feature</span></a>
            <a className="card linked-card media-card media-visual-card" href="https://lymphedasia.com/educational-resources/" target="_blank" rel="noreferrer"><div className="media-card-image"><Image src="/images/media/nhk-lymphedema-documentary.jpg" alt="Thumbnail for NHK documentary feature on lymphedema surgeons in Japan" width={1024} height={600} /></div><small>NHK documentary</small><h3>Lymphedema surgeons in Japan</h3><p>Featured in an NHK documentary segment on lymphedema surgeons and lymphatic surgery in Japan.</p><span>View resource</span></a>
          </div>
        </div>
      </section>
