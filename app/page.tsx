      ...
      <section id="articles" className="section segmented-section segment-articles mobile-transition">
        <div className="container">
          ...
          <div className="grid-3">
            ...
            <a className="card blog-card linked-card" href="/body-contouring-liposuction-singapore"><small>Body contouring</small><h3>Body contouring and liposuction in Singapore</h3><p>Educational guide to body contouring, liposuction planning, skin quality, recovery and safety considerations after weight or body-shape changes.</p><span>Read page</span></a>
            <a className="card blog-card linked-card" href="/thread-lifting-singapore"><small>Facial rejuvenation</small><h3>Thread lifting in Singapore</h3><p>Patient information on dissolvable thread lift planning, face and neck rejuvenation, realistic limits, recovery and risks.</p><span>Read page</span></a>
